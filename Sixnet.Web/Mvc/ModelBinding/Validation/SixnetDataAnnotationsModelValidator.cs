...
{
    public class SixnetDataAnnotationsModelValidator : IModelValidator
    {
        ...
        public SixnetDataAnnotationsModelValidator(
        ...
        public IEnumerable<ModelValidationResult> Validate(ModelValidationContext validationContext)
        {
            ...
            {
                throw new ArgumentException(nameof(validationContext.ModelMetadata));
            }
            if (validationContext.MetadataProvider == null)
            {
                throw new ArgumentException(nameof(validationContext.MetadataProvider));
            }
